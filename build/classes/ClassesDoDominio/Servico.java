...
public class Servico implements Serializable {
    private String nomeCliente, nomeAnimal, tipoServico, horarioServico;
    ...
    public Servico(String cliente, String animal, String tipo, Calendar data, String horario) {
        nomeCliente = cliente;
        nomeAnimal = animal;
        tipoServico = tipo;
        dataServico = data;
    ...
    public void setDataServico(Calendar data) {
        dataServico = data;
    }
